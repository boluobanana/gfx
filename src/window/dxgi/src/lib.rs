...
pub fn init<Cf, T: 'static>(wb: winit::window::WindowBuilder, events_loop: &winit::event_loop::EventLoop<T>)
...
pub fn init_raw<T: 'static>(wb: winit::window::WindowBuilder, events_loop: &winit::event_loop::EventLoop<T>, color_format: format::Format)
